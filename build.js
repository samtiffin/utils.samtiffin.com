...
$__System.registerDynamic("9", [], true, function(req, exports, module) {
  ...
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = ['as', 'because', 'for', 'and', 'nor', 'but', 'or', 'yet', 'so'];
  global.define = __define;
  return module.exports;
});

$__System.registerDynamic("a", ["7", "8", "9"], true, function(req, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  ...
  var laxWords = req('7').concat(req('8')).concat(req('9')).concat(smallWords.source.replace(/(^\^\(|\)\$$)/g, '').split('|')).concat(['is']),
...
$__System.register('1', ['2', '4', '6', 'b'], function (_export) {
    'use strict';
    ...
    function capitaliseFirst(string, separator) {
        ...
        for (var i = 0; i < parts.length; i++) {
            parts[i] = parts[i].replace(/\w/, function (a) {
